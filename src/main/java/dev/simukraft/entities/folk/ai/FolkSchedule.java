...
public class FolkSchedule {
    ...
    public static DeferredRegister<Schedule> FOLK_SCHEDULE = DeferredRegister.create(ForgeRegistries.SCHEDULES, SimUKraft.MOD_ID);
    ...
    public static <T extends Schedule> RegistryObject<T> register(String pKey, Supplier<T> schedule) {
        return FOLK_SCHEDULE.register("folk_default", schedule);
    }
}
